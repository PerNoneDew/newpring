...
import { Bell, CalendarPlus, CreditCard, XCircle, Settings as SettingsIcon, ChevronRight } from 'lucide-react';
import { Booking, EventBooking } from '../../lib/types';

type NotificationType = 'reservation' | 'payment' | 'cancellation' | 'system';
